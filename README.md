...
- The **Maturing segment** (6–50 interactions) collapses to NDCG@10 = 0.0091 due to a count regime mismatch between training (running count) and evaluation (total countmap). 
